...
public class cachier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton7.setBounds(790, 0, 100, 20);
        ...
        jButton8.setBounds(890, 0, 100, 20);

        jLabel11.setFont(new java.awt.Font("Tahoma", 3, 24)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(51, 51, 255));
        jLabel11.setText("Gestion de vente des médicaments ");
        jPanel1.add(jLabel11);
        jLabel11.setBounds(250, 0, 430, 30);

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 990, 140));
        ...
        jPanel2.add(jLabel5);
        jLabel5.setBounds(40, 20, 250, 20);
        ...
        jPanel2.add(comrech);
        comrech.setBounds(10, 50, 300, 20);
        jPanel2.add(txtrech);
        txtrech.setBounds(150, 80, 160, 20);
        ...
        txtpri.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        jLabel13.setText("Total à payer:");
        jPanel2.add(jLabel13);
        jLabel13.setBounds(30, 460, 130, 30);
        ...
        jButton5.setBounds(10, 80, 105, 20);

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 340, 550));
        ...
        jLabel20.setText("montant payé :");
        jPanel3.add(jLabel20);
        jLabel20.setBounds(10, 380, 120, 30);
        ...
        jPanel3.add(jPanel4);
        jPanel4.setBounds(10, 10, 630, 70);

        jLabel21.setFont(new java.awt.Font("Tahoma", 3, 18)); // NOI18N
        jLabel21.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel21.setText("Total  à payer:");
        jPanel3.add(jLabel21);
        jLabel21.setBounds(170, 310, 150, 30);
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 150, 650, 550));
    ...
    private void tbl_resMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_resMouseClicked
        ...
        txtran.setEnabled(false);
        txtfou.setEnabled(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtcas.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "saisir le montant à payer !!!");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (txtrech.getText().equals("")) {
            JOptionPane.showMessageDialog(this, " Remplir le champ de recherche");
        } else {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (txtcod.getText().equals("") || txtref.getText().equals("") || txtran.getText().equals("")
            ...
            try {
                if (!test_stock()) { 
                    JOptionPane.showMessageDialog(this, "Quantité demandé non disponible !!");
                } else {
                    def(); //true
                    table(); //true
                }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(this,"étes vous sùr de vouloir annuler la vente !!! ","attention", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
...
payaprés();        // TODO add your handling code here:
    ...
    private void txtpriKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtpriKeyTyped
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_txtpriKeyTyped

    private void txtremKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtremKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_txtremKeyTyped

    private void txtcasKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcasKeyTyped
