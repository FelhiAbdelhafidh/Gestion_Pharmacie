...
public class Produit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(10, 120, 820, 150);
        ...
        jButton2.setBounds(20, 300, 110, 40);
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(10, 360, 500, 190);

        jPanel3.setBackground(new java.awt.Color(204, 255, 255));
        jPanel3.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(51, 51, 255), null));
        ...
        jButton1.setBounds(10, 100, 131, 30);

        comrech.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        jPanel3.add(comrech);
        comrech.setBounds(40, 70, 240, 20);
        ...
        jPanel3.add(txtrech);
        txtrech.setBounds(150, 100, 150, 30);

        jPanel1.add(jPanel3);
        jPanel3.setBounds(520, 290, 310, 260);
        ...
        jLabel6.setText("Gestion des médicaments ");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(120, 40, 480, 50);

        jButton6.setFont(new java.awt.Font("Tahoma", 3, 10)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (txtid.getText().equals("") || txtref.getText().equals("") || txtdes.getText().equals("")
            ...
            JOptionPane.showMessageDialog(this, " Remplir tous champs");
        } else {
   ...
   if (txtid.getText().equals("") && txtref.getText().equals("") && txtdes.getText().equals("")
            ...
            JOptionPane.showMessageDialog(this, "Choisir le médicaments à modifier !!");
        }
    else    if  (txtid.getText().equals("") || txtref.getText().equals("") || txtdes.getText().equals("")
                || txtfou.getText().equals("") || txtran.getText().equals("") || txtrem.getText().equals("")
                || txtpri.getText().equals("") || txtsto.getText().equals("")
                ) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (txtid.getText().equals("") && txtref.getText().equals("") && txtdes.getText().equals("")
            ...
            JOptionPane.showMessageDialog(this, "Choisir le médicaments à supprimer !!");
        }
        String id = String.valueOf(tbl_prod.getValueAt(tbl_prod.getSelectedRow(), 0));
       
        if (JOptionPane.showConfirmDialog(this, "Attention :\n Vous allez supprimer ce médicament !!", "attention!!!", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
...
if (txtrech.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Remplir le champ recherche !!");
        } else {
